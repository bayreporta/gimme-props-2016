...
function configureSlides(direct){
	...
	//ABOUT
	if (curSlide == '#intro' && direct == 'right' || curSlide == '#whoweare' && direct == 'up'){    
...
function rainingCoins(){
	...
	$('#proplist59').append(coin).append(coin).append(coin).append(coin).append(coin);
	$('#proplist59 svg:eq(1)').css({top:-200, left:'80%'}).animate({top:3000},5500);
	$('#proplist59 svg:eq(2)').css({top:-200, left:'40%'}).animate({top:3000},6000);
	$('#proplist59 svg:eq(3)').css({top:-200, left:'50%'}).animate({top:3000},5000);
	$('#proplist59 svg:eq(4)').css({top:-200, left:'70%'}).animate({top:3000},6500, function(){
		$('.coins').remove();
	});
